module Api
  class UsersController < Api::ApplicationController
    ...
    def index
      ...
      render json: users,
             each_serializer: Api::UserBaseSerializer,
             status: 200
    end

    def show
      render json: user, serializer: Api::UserBaseSerializer, status: 200
    end
    ...
    def create
      ...
      if user.save
        render json: user, serializer: Api::UserBaseSerializer, status: 201
      else
    ...
    def destroy
      if user.destroy
        render json: User.all, each_serializer: Api::UserBaseSerializer, status: 200
      else
